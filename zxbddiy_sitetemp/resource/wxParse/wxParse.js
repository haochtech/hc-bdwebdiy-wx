...
function bdParse() {
    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "bdParseData", t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "html", a = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : '<div class="color:red;">数据不能为空</div>', i = arguments[3], r = arguments[4], n = i, o = {};
    ...
    var s = {};
    s[e] = o, n.setData(s), n.bdParseImgLoad = bdParseImgLoad, n.bdParseImgTap = bdParseImgTap;
}

function bdParseImgTap(e) {
    var t = e.target.dataset.src, a = e.target.dataset.from;
    void 0 !== a && 0 < a.length && swan.previewImage({
        current: t,
        urls: [ t ]
    });
}
...
function bdParseTemArray(e, t, a, i) {
    for (var r = [], n = i.data, o = null, d = 0; d < a; d++) {
        var s = n[t + d].nodes;
        r.push(s);
    }
    e = e || "bdParseTemArray", (o = JSON.parse('{"' + e + '":""}'))[e] = r, i.setData(o);
}

function emojisInit() {
    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "", t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "/bdParse/emojis/", a = arguments[2];

...
Page({
    ...
    toorder: function(t) {
        var a = "/zxbddiy_sitetemp/pages/deskorder/orderlist?type=" + t.currentTarget.dataset.type + (this.data.tid ? "&tid=" + this.data.tid : "");
        swan.navigateTo({
            url: a
        });
    },
    ...
    updateUserInfo: function(t) {
        var a = this;
        t.detail.errMsg && app.com.getUserInfo(function(t) {
            a.setData({
                showuserbtn: !1,
                wxuser: t.wxInfo
            });

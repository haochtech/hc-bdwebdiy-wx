...
Page(Object.assign({}, app.zan.Quantity, {
    ...
    onLoad: function(a) {
        var e = this;
        app.com.comfunc(this), a.gid = a.gid ? a.gid : a.scene ? a.scene : 0, e.setData({
            ...
            e.setData({
                ...
                t.data.errno ? app.com.alert(t.data.message) : (e.setData({
                    good: t.data.data.good,
                    "quantity.max": t.data.data.good.stock,
                    rule: t.data.data.good.rulearray.rule,
                    rulemap: t.data.data.good.rulearray.rulemap,
                    sets: t.data.data.set
                }), require("../../resource/bdParse/bdParse.js").bdParse("good.content", "html", t.data.data.good.content, e, 0), 
                swan.setNavigationBarTitle({
                    title: t.data.data.good.title
        ...
        if ("buy" == t.currentTarget.dataset.type) {
            ...
            app.com.http("good", "POST", o, 0, !0, "", "", function(t) {
                t.data.errno || void 0 === t.data.errno ? app.util.message(t.data.message, "", "error") : swan.navigateTo({
                    url: "/zxbddiy_sitetemp/pages/deskorder/confirm?tid=" + a.data.tid
                });
            });

...
Page(Object.assign({}, app.zan.NoticeBar, {
    ...
    onLoad: function(r) {
        ...
        r.pindex = t, r.state = !0, o.setData({
            ...
            if (!i.data.errno) {
                ...
                }), swan.stopBackgroundAudio(), 1 == a.params.basic.isaudio && a.params.basic.audiourl && o.playbg(), 
    ...
    playaudio: function(a) {
        ...
        t.data.playaudioid == e && t.data.playaudioing ? (swan.pauseBackgroundAudio(), t.setData({
            playaudioing: !1
        })) : (t.data.playaudioid != e && swan.stopBackgroundAudio(), swan.playBackgroundAudio({
            dataUrl: r,
            success: function() {
                t.setData({
                    playaudioid: e,

...
Page(Object.assign({}, app.zan.NoticeBar, {
                ...
                if (a.id || app.com.alert("页面不存在"), o.setData({
                    ...
                    for (var a = 0; a < o.data.page.data.length; a++) {
                        ...
                        if ("text" == o.data.page.data[a].name) {
                            ...
                            t.bdParse(e, "html", o.data.page.data[a].params.content, o, 5);
                           o.setData({
                               e:e
                           })
                        }
    ...
    playbg: function () {
        ...
        innerAudioContext.src = a.data.page.basic.audiourl;
        ...
        innerAudioContext.onPlay(function (res) {
            a.setData({
                audioplaying: !0
            }), swan.createInnerAudioContext().onStop(function () {
                a.playbg();
            });
        });
    },

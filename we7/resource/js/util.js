...
function getSign(e, t, n) {
    ...
    f < i.length - 1 && (c += "&"));
    return o = r((c = c.substring(0, c.length - 1)) + (n = n || getApp().siteInfo.token));
}
...
util.url = function(e, t) {
    ...
    var n = swan.getStorageSync("userInfo").sessionid, i = a.url;
    if (-1 == i.indexOf("http://") && -1 == i.indexOf("https://") && (i = util.url(i)), 
    getUrlParam(i, "state") || a.data && a.data.state || !n || (i = i + "&state=we7sid-" + n), 
    !a.data || !a.data.m) {
        var o = getCurrentPages();
        o.length && (o = o[getCurrentPages().length - 1]) && o.uri && (i = i + "&m=" + o.uri.split("/")[0]);
    }
    ...
    swan.request((_defineProperty(e = {
        ...
        if (swan.hideLoading(), e.data.errno) {
            if ("41009" == e.data.errno) return swan.setStorageSync("userInfo", ""), void util.getUserInfo(function() {
                util.request(a);
            });
            ...
            swan.setStorageSync(u, n);
        }
    }), _defineProperty(e, "fail", function(e) {
        swan.hideLoading();
        var t = require("md5.js")(i), n = swan.getStorageSync(t);
    ...
    var n = swan.getStorageSync("userInfo") || {};
    if(!n.nickname){
       swan.getUserInfo({
            success: res => {
                let userInfo = res.userInfo;
                n.nickName=userInfo.nickName;
                n.avatarUrl=userInfo.avatarUrl;
            },
            fail: err => {
                console.log(err);
                swan.showToast({
    ...
    util.request({
        ...
        success: function(e) {
            ...
            swan.setStorageSync("userInfo", n));
            // console.log(swan.getStorageSync("userInfo"));
    ...
    swan.getUserInfo({success: res => {
    e=res;
    n.wxInfo = e.userInfo, n.wxInfo.nickname = n.wxInfo.nickName, n.wxInfo.headimgurl = n.wxInfo.avatarUrl, 
    util.request({
        ...
        cachetime: 0,
        success: function(e) {
            e.data.errno || (n.memberInfo = e.data.data, swan.setStorageSync("userInfo", n)), 
            "function" == typeof t && t(n);
        }
        });
    }});
        ...
        swan.login({
            success: function(e) {
                util.getWe7User(function(e) {
                    ...
                    }) : swan.canIUse("getUserInfo") ? swan.getUserInfo({
                        withCredentials: !0,
                        success: function(e) {
    ...
    }, a = swan.getStorageSync("userInfo") || {};
    a.sessionid ? util.checkSession({
        ...
        fail: function() {
            a.sessionid = "", console.log("relogin"), swan.removeStorageSync("userInfo"), e();
        }
    }) : e();
    ...
    n || (n = "success"), "success" == n ? swan.showToast({
        title: e,
        icon: "success",
        duration: 2e3,
        mask: !!r,
    ...
    swan.getStorageSync("isShowLoading") && (swan.hideLoading(), swan.setStorageSync("isShowLoading", !1)), 
    swan.showLoading({
        title: "加载中",
        mask: !0,
        complete: function() {
            swan.setStorageSync("isShowLoading", !0);
        },
        fail: function() {
            swan.setStorageSync("isShowLoading", !1);
        }
    });
